# Dicionário ASCII: código binário de 8 bits → caractere printável
caracteres_printaveis = {
    "00100000": " ",
...
if __name__ == "__main__":
    print(f"Total de caracteres: {len(caracteres_printaveis)}")
    print("Exemplo:", list(caracteres_printaveis.items())[:10])