word_counts_english_rank = {
 ...
 #   "BLEAK": 53, #FORÇADO
  ...
  #  "FREQUENT": 59, #FORÇADO segundo encoded ->>> TEXTO 2
    ...
    #"AGAIN": 56, #FORÇADO segundo encoded
    
    #"KILL": 57, #FORÇADO segundo encoded
    #"KNOWN": 58, #FORÇADO segundo encoded
    #"SPECK": 59, #FORÇADO segundo encoded
    #"DARK": 60, #FORÇADO segundo encoded
    #"KING": 61, #FORÇADO segundo encoded
    #"THINK": 62, #FORÇADO segundo encoded
    #"LIKE": 63, #FORÇADO segundo encoded
    #"MAKE": 64, #FORÇADO segundo encoded
}
